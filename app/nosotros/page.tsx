  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <main className="max-w-[1920px] mx-auto">
        ...
        <section
          className="px-6 md:px-12 py-10 md:py-14 border-y border-[var(--text-secondary)]/12 bg-[var(--background-elevated)]/50"
          aria-label="Cifras"
        >
          <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
            <div>
              ...
              <p className="text-sm font-medium text-[var(--text-secondary)] mt-1 uppercase tracking-wider">
                Años de experiencia
              </p>
            </div>
            <div>
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 pt-16 md:pt-24 pb-8">
          {/* Misión — card con pullquote */}
          <section className="scroll-mt-24 mb-20 md:mb-28" id="mision">
            <div className="rounded-2xl border border-[var(--text-secondary)]/10 bg-[var(--background)] p-6 md:p-10 shadow-[var(--shadow-card)]">
              <p className="text-xs font-semibold text-[var(--accent)] uppercase tracking-[0.2em] font-sans mb-4">
                Nuestra misión
              </p>
              <blockquote
                className="text-xl md:text-2xl text-[var(--text-primary)] leading-snug font-medium font-sans mb-6 border-l-4 border-[var(--accent)] pl-5"
                style={{ fontFamily: "var(--font-instrument-serif), Georgia, serif" }}
              >
                Soluciones inmobiliarias integrales en Bucaramanga: seguridad, confianza y rentabilidad para propietarios e inversionistas.
              </blockquote>
              <p className="text-[var(--text-secondary)] text-base md:text-lg leading-relaxed">
                Nos especializamos en la administración de inmuebles con un enfoque transparente, respaldado por solidez financiera y tecnología de vanguardia. A través de un equipo capacitado y alianzas con aseguradoras líderes, protegemos el patrimonio de nuestros clientes con un servicio ágil, personalizado y enfocado en la excelencia.
              </p>
            </div>
          </section>

          {/* Visión — mismo tratamiento */}
          <section className="scroll-mt-24 mb-20 md:mb-28" id="vision">
            <div className="rounded-2xl border border-[var(--text-secondary)]/10 bg-[var(--background)] p-6 md:p-10 shadow-[var(--shadow-card)]">
              <p className="text-xs font-semibold text-[var(--accent)] uppercase tracking-[0.2em] font-sans mb-4">
                Nuestra visión
              </p>
              ...
              <p className="text-[var(--text-secondary)] text-base md:text-lg leading-relaxed">
                Nos destacamos por ética, transparencia y excelencia en administración y comercialización de bienes raíces. Transformamos el sector con innovación, tecnología avanzada y servicio personalizado, asegurando tranquilidad y rentabilidad para nuestros clientes.
              </p>
            </div>
          </section>
          ...
          <section className="scroll-mt-24 mb-20 md:mb-28" id="valor">
            ...
            <ul className="grid sm:grid-cols-2 gap-4 md:gap-5">
              {[
                ...
                <li
                  key={i}
                  className="group flex gap-4 p-4 md:p-5 rounded-xl bg-[var(--background-elevated)]/70 border border-transparent hover:border-[var(--text-secondary)]/15 hover:bg-[var(--background-elevated)] transition-colors"
                >
                  <span
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[var(--accent)]/10 text-[var(--accent)] group-hover:bg-[var(--accent)]/15 transition-colors"
                    aria-hidden
                  >
                    {item.icon === "person" && (
              ...
              <div className="relative max-w-2xl">
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 h-12 px-6 rounded-xl bg-white text-[#722F37] font-semibold hover:bg-white/95 transition-colors shadow-lg"
                  >
